    ...
    return createPortal(
        <Overlay>
            ...
            <Button onClick = {() => closeModal()}>
                ...
                {name === "cabin-form" ? cloneElement(children, {setIsModalOpen: closeModal}): name === "confirm-delete" || name === "delete-booking" ? cloneElement(children, {closeModal: closeModal}): cloneElement(children, {setEditShowForm: closeModal})} 
            </StyledModal>
        </Overlay>,
        document.body
    )
